...
<!-- Il faut _autant de couleurs qu'il y a de classes_. -->
...
L'argument `style` de la fonction `tm_polygons()` peut recevoir les valeurs suivantes : `"cat"`, `"fixed"`, `"sd"`, `"equal"`, `"pretty"`, `"quantile"`, `"kmeans"`, `"hclust"`, `"bclust"`, `"fisher"`...
L'argument `n` reçoit le nombre de classes à construire.
