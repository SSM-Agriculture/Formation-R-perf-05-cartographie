...
- `{sf}` (4.4) : ensemble de fonctions pour gérer les objets spatiaux (import, traitement, export...) ([documentation](https://r-spatial.github.io/sf/))
- `{tmap}` (4.2) : réalisation simple de cartes ([documentation](https://r-tmap.github.io/tmap/))
- `{RcolorBrewer}` : palettes de couleurs décrites sur <https://colorbrewer2.org/>
...
Affichage par défaut avec `plot(bio |> select(geom, part_exp_bio))`.
...
![](images/2-3-cas_part_expl_bio-tm_polygons.png){fig-align="center"}
...
```r
# mode "view" interactif <https://r-tmap.github.io/tmap/reference/tmap_mode.html>
tmap_mode("view")
tm_shape(bio) +
    tm_polygons(
        "part_exp_bio",
...
![](images/2-3-cas_part_expl_bio-tm_polygons_interactif.png){fig-align="center"}
